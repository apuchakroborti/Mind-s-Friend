...
<div class="container"-->
    ...
    $sql = "SELECT email FROM admin_list WHERE email='$email' ";
    ...
    {
        $sql = "INSERT INTO admin_list (fullname ,email, password)
    ...
    {
        echo "<b>Something Error Occur such as Email already Used </b>".'<br>';
        echo "<meta http-equiv='refresh' content='3;admin_signup.html' />";
    }
