...
<div class="container">
    ...
    else if ($sum>=101 && $sum<=114)
    {
        $str = "Mild";
    }
    else if ($sum>=115 && $sum<=123)
    {
        $str = "Moderate";
    }
    else if ($sum>=124 && $sum<=150)
    {
        $str = "Severe";
    }
    ...
    echo '
            ...
            <h4>Your score is '.$sum.' and depression level is '.$str.'.<br></h4>
    ...
    if($sum>94)
    {
        echo '
            ...
            <h4>Your depression level is greater than 94, we suggest you to take help of any professional psychologist or 
